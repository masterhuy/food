       ...
       <div class="row align-items-center">
           <div class="layout-column col-auto header-left">
                <a data-toggle="collapse" data-target="#ver-menu" class="vermenu-btn collapsed align-items-center" aria-expanded="false">
                    <i class="feather icon-shopping-cart"></i>{$gdzSetting.vermenu_button_text nofilter}
                </a>
                <div id="ver-menu" class="navbar collapse{if $gdzSetting.vermenu_class} {$gdzSetting.vermenu_class}{/if}" aria-expanded="false">
