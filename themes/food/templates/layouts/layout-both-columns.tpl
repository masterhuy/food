            ...
            <div id="wrapper" class="{$layout}">
                ...
                {/if}
                    {block name="left_column"}
                        <div id="left-column" class="page-column col-lg-3 col-md-4 col-sm-12 col-xs-12 hidden-sm-down">
                    ...
                    {block name="right_column"}
                        <div id="right-column" class="page-column col-lg-3 col-md-4 col-sm-12 col-xs-12 hidden-sm-down">
                            {if $page.page_name == 'product'}
