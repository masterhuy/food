            ...
            <div id="wrapper" class="{$layout}">
                ...
                {/if}
                    {block name="left_column"}
                        <div id="left-column" class="left-column col-lg-3 col-md-4 col-sm-12 col-xs-12">
                    ...
                    {block name="right_column"}
                        <div id="right-column" class="right-column col-lg-3 col-md-4 col-sm-12 col-xs-12">
                            {if $page.page_name == 'product'}
