		...
		<div class="product-info">
    		...
    		<div class="product-buttons">
				{if $gdzSetting.productbox_wishlist}
					<a href="#" class="addToWishlist btn-icon" onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|escape:'html'}', false, 1); return false;" data-id-product="{$product.id_product|escape:'html'}">
				...
				{if $gdzSetting.productbox_quickview}
					<a href="#" data-link-action="quickview" class="btn-icon quick-view">
