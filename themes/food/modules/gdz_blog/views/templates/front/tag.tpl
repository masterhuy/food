...
<h3 class="title-blog">{l s='Tag' mod='gdz_blog'} : {$tag nofilter}</h3>
	...
	<div class="post-list">
		{foreach from=$posts item=post}
			...
			<article class="blog-post">
				<h4 class="post-title"><a href="{gdz_blog::getPageLink('gdz_blog-post', $params) nofilter}">{$post.title nofilter}</a></h4>
				<ul class="post-meta">
