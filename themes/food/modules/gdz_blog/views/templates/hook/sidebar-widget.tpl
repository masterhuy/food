...
<aside class="blog-widget widget-tabs">
	<div role="tabpanel" class="jms-tab">
		 <ul class="nav nav-tabs">
			...
			<li class="nav-item"><a href="#popularpost" class="active" aria-controls="popularpost" data-toggle="tab">{l s='Popular' mod='gdz_blog'}</a></li>
			{/if}
			{if $widget_setting.GBW_SB_SHOW_RECENT}
			<li class="nav-item"><a href="#latestpost" aria-controls="latestpost" data-toggle="tab" class="{if !$widget_setting.GBW_SB_SHOW_POPULAR}active{/if}">{l s='Recent' mod='gdz_blog'}</a></li>
			{/if}
			{if $widget_setting.GBW_SB_SHOW_LATESTCOMMENT}
			<li class="nav-item"><a href="#latestcomment" aria-controls="latestpost" class="{if !$widget_setting.GBW_SB_SHOW_POPULAR && !$widget_setting.GBW_SB_SHOW_RECENT} active{/if}" data-toggle="tab">{l s='Comments' mod='gdz_blog'}</a></li>
			{/if}
		  </ul>
