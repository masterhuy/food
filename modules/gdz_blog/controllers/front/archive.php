...
class gdz_blogArchiveModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function initContent()
    {
        ...
        $this->setTemplate('module:gdz_blog/views/templates/front/archive.tpl');
    }
    public function getBreadcrumbLinks()
    {
        $_month = Tools::getValue('archive');
        $_link = gdz_blog::getPageLink('gdz_blog-archive', array('archive' => $_month));
