...
class gdz_blogCategoryModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function initContent()
    {
        ...
        $category   = gdz_blogHelper::getCategory($category_id);
        ...
        $this->setTemplate('module:gdz_blog/views/templates/front/category.tpl');
    }
