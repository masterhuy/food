...
class gdzInstall
{
    ...
    {
        $sql = array();
        $sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'gdz_blog_categories` (
        ...
        $sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'gdz_blog_categories_lang` (
                `category_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
        ...
        $sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'gdz_blog_posts` (
        ...
        $sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'gdz_blog_posts_comments` (
        ...
        $sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'gdz_blog_posts_lang` (
                `post_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
                `id_lang` int(10) unsigned NOT NULL,
                `title` varchar(255) NOT NULL,
                `alias` varchar(255) NOT NULL,
    ...
    public function installSamples()
    {
        ...
        for ($i = 1; $i < 7; $i++) {
            ...
            foreach ($languages as $language) {
                ...
                $item->alias[$language['id_lang']] = gdz_blogHelper::makeAlias($item->title[$language['id_lang']]).'-'.($i + 1);
